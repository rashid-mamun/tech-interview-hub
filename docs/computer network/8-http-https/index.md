...
### ⚠️ Why do browsers show "Your connection is not private" for 401 errors?
...
HttpOnly থাকলে JS দিয়ে access করাই যাবে বাহির থেকে! ✅
```
##### ৫. SameSite Cookie
```text
...
- **HTTP/3** TCP-কে সরিয়ে QUIC (UDP) নিয়ে আসে। এতে মোবাইলে সুইচিং (ওয়াইফাই থেকে ডাটা) হলে কানেকশন লস্ট হয় পণ্ডিত হয় না এবং কানেকশন স্পিড অবিশ্বাস্যভাবে বাড়ে।
